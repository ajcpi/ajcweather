...
def user_agent():
    ...
    ***REMOVED***
    ...
    if sys.platform.startswith("darwin") and platform.mac_ver()[0]:
        data["distro"] = {"name": "OS X", "version": platform.mac_ver()[0]***REMOVED***

    if platform.system():
        data.setdefault("system", {***REMOVED***)["name"] = platform.system()

    if platform.release():
        data.setdefault("system", {***REMOVED***)["release"] = platform.release()
    ...
    return "{data[installer][name]***REMOVED***/{data[installer][version]***REMOVED*** {json***REMOVED***".format(
        data=data,
...
class PipSession(requests.Session):
    ...
    def __init__(self, *args, **kwargs):
        ...
        for host in insecure_hosts:
            self.mount("https://{0***REMOVED***/".format(host), insecure_adapter)
