...
def get_config_var(var):
    try:
        ...
        warnings.warn("{0***REMOVED***".format(e), RuntimeWarning)
        return None
...
def get_impl_tag():
    ...
    """
    return "{0***REMOVED***{1***REMOVED***".format(get_abbr_impl(), get_impl_ver())
...
def get_platform():
    ...
    if sys.platform == 'darwin':
        ...
        return 'macosx_{0***REMOVED***_{1***REMOVED***_{2***REMOVED***'.format(split_ver[0], split_ver[1], machine)
    ...
    if not noarch:
        ...
        if sys.platform == 'darwin':
            ...
            if match:
                ...
                tpl = '{0***REMOVED***_{1***REMOVED***_%i_%s'.format(name, major)
                arches = []
