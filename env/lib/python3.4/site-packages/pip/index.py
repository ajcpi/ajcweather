...
class InstallationCandidate(object):
    ...
    def __repr__(self):
        return "<InstallationCandidate({0!r***REMOVED***, {1!r***REMOVED***, {2!r***REMOVED***)>".format(
