...
class InstallRequirement(object):
    ...
    def __init__(self, req, comes_from, source_dir=None, editable=False,
        ...
        self.options = options if options else {***REMOVED***
    ...
    def from_editable(cls, editable_req, comes_from=None, default_vcs=None,
        ...
        res = cls(name, comes_from, source_dir=source_dir,
                  ...
                  isolated=isolated,
                  options=options if options else {***REMOVED***,
    ...
    def uninstall(self, auto_confirm=False):
        ...
        develop_egg_link_egg_info = '{0***REMOVED***.egg-info'.format(
        ...
        if (egg_info_exists and dist.egg_info.endswith('.egg-info') and
            ...
            warnings.warn(
                "Uninstalling a distutils installed project ({0***REMOVED***) has been "
    ...
    def install_editable(self, install_options,
        ...
        if prefix:
            prefix_param = ['--prefix={0***REMOVED***'.format(prefix)]
    ...
    def has_hash_options(self):
        ...
        """
        return bool(self.options.get('hashes', {***REMOVED***))
    ...
    def hashes(self, trust_internet=True):
        ...
        """
        good_hashes = self.options.get('hashes', {***REMOVED***).copy()
