...
class DistributionNotFound(ResolutionError):
    ...
    _template = ("The '{self.req***REMOVED***' distribution was not found "
                 "and is required by {self.requirers_str***REMOVED***")
...
def _macosx_arch(machine):
    return {'PowerPC': 'ppc', 'Power_Macintosh': 'ppc'***REMOVED***.get(machine, machine)
...
class _ReqExtras(dict):
    ...
    def markers_pass(self, req):
        ...
        """
        extra_evals = (
            req.marker.evaluate({'extra': extra***REMOVED***)
...
_declare_state('dict', _distribution_finders = {***REMOVED***)
...
_declare_state('dict', _namespace_handlers={***REMOVED***)
_declare_state('dict', _namespace_packages={***REMOVED***)
...
def _normalize_cached(filename, _cache={***REMOVED***):
    try:
...
class Distribution(object):
    ...
    def _warn_legacy_version(self):
        ...
        tmpl = textwrap.dedent("""
            '{project_name***REMOVED*** ({version***REMOVED***)' is being parsed as a legacy,
            non PEP 440,
    ...
    def _dep_map(self):
        try:
            ...
            dm = self.__dep_map = {None: []***REMOVED***
    ...
    def get_entry_map(self, group=None):
        ...
        if group is not None:
            return ep_map.get(group,{***REMOVED***)
        return ep_map
...
class DistInfoDistribution(Distribution):
    ...
    def _compute_dependencies(self):
        ...
        def reqs_for_extra(extra):
            for req in reqs:
                if not req.marker or req.marker.evaluate({'extra': extra***REMOVED***):
                    yield req
