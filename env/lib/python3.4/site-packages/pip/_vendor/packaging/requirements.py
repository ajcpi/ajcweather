...
class Requirement(object):
    ...
    def __str__(self):
        ...
        if self.extras:
            parts.append("[{0***REMOVED***]".format(",".join(sorted(self.extras))))

        if self.specifier:
            parts.append(str(self.specifier))

        if self.url:
            parts.append("@ {0***REMOVED***".format(self.url))

        if self.marker:
            parts.append("; {0***REMOVED***".format(self.marker))

        return "".join(parts)

    def __repr__(self):
        return "<Requirement({0!r***REMOVED***)>".format(str(self))
