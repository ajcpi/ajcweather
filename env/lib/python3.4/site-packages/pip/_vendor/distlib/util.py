...
RICH_GLOB = re.compile(r'\{([^***REMOVED***]*)\***REMOVED***')
_CHECK_RECURSIVE_GLOB = re.compile(r'[^/\\,{]\*\*|\*\*[^/\\,***REMOVED***]')
_CHECK_MISMATCH_SET = re.compile(r'^[^{]*\***REMOVED***|\{[^***REMOVED***]*$')


def iglob(path_glob):
    """Extended globbing function that supports ** and {opt1,opt2,opt3***REMOVED***."""
    if _CHECK_RECURSIVE_GLOB.search(path_glob):
        msg = """invalid glob %r: recursive glob "**" must be used alone"""
        raise ValueError(msg % path_glob)
    if _CHECK_MISMATCH_SET.search(path_glob):
        msg = """invalid glob %r: mismatching set marker '{' or '***REMOVED***'"""
        raise ValueError(msg % path_glob)
