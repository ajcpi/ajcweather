...
class Locator(object):
    ...
    def locate(self, requirement, prereleases=False):
        ...
        if result:
            ...
            result.download_urls = versions.get('urls', {***REMOVED***).get(version, set())
            d = {***REMOVED***
            sd = versions.get('digests', {***REMOVED***)
    ...
    def get_page(self, url):
        ...
        if url in self._page_cache:
            ...
            if host in self._bad_hosts:
                ...
                req = Request(url, headers={'Accept-encoding': 'identity'***REMOVED***)
                try:
    ...
    def _get_project(self, name):
        ...
        if data:
            for info in data.get('files', []):
                ...
                md.dependencies = info.get('requirements', {***REMOVED***)
                dist.exports = info.get('exports', {***REMOVED***)
...
class DistPathLocator(Locator):
    ...
    def _get_project(self, name):
        ...
        if dist is None:
            ...
            result = {
                dist.version: dist,
                'urls': {dist.version: set([dist.source_url])***REMOVED***,
                'digests': {dist.version: set([None])***REMOVED***
            ***REMOVED***
        return result
...
class AggregatingLocator(Locator):
    ...
    def _get_project(self, name):
        ...
        for locator in self.locators:
            ...
            if d:
                if self.merge:
                    files = result.get('urls', {***REMOVED***)
                    digests = result.get('digests', {***REMOVED***)
