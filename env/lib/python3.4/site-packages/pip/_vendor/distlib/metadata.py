...
class Metadata(object):
    ...
    SUMMARY_MATCHER = re.compile('.{1,2047***REMOVED***')
    ...
    def __setattr__(self, key, value):
        ...
        if key in mapped:
            ...
            if self._legacy:
                ...
                # special cases for PEP 459
                d = self._data.setdefault('extensions', {***REMOVED***)
                if key == 'commands':
                    d['python.commands'] = value
                elif key == 'classifiers':
                    d = d.setdefault('python.details', {***REMOVED***)
                    d[key] = value
                else:
                    d = d.setdefault('python.exports', {***REMOVED***)
                    d[key] = value
        elif key not in common:
        ...
        ***REMOVED***
        ...
        for ok, nk in keys:
            if ok in lmd and lmd[ok]:
                result[nk] = [{'requires': lmd[ok]***REMOVED***]
