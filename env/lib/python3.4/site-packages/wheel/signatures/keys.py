...
class WheelKeys(object):
    ...
    def __init__(self):
        self.data = {'signers':[], 'verifiers':[]***REMOVED***
    ...
    def trust(self, scope, vk):
        ...
        self.data['verifiers'].append({'scope':scope, 'vk':vk***REMOVED***)
        return self
    
    def untrust(self, scope, vk):
        """Stop trusting a particular key for given scope."""
        self.data['verifiers'].remove({'scope':scope, 'vk':vk***REMOVED***)
        return self
    ...
    def add_signer(self, scope, vk):
        ...
        self.data['signers'].append({'scope':scope, 'vk':vk***REMOVED***)
