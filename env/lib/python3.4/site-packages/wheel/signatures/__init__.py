...
def sign(payload, keypair):
    ...
    return {"recipients": 
            [{"header":native(encoded_header),
             "signature":native(encoded_signature)***REMOVED***],
            "payload": native(encoded_payload)***REMOVED***
...
def verify(jwsjs):
    ...
    for recipient in recipients:
        assertTrue(len(recipient) == 2, "Unknown recipient key {0***REMOVED***".format(recipient))
        ...
        assertTrue(header["alg"] == ALG, 
                "Unexpected algorithm {0***REMOVED***".format(header["alg"]))
        ...
        assertTrue(header["jwk"]["kty"] == ALG, # true for Ed25519
                "Unexpected key type {0***REMOVED***".format(header["jwk"]["kty"]))
