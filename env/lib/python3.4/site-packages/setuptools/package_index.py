...
PYPI_MD5 = re.compile(
    '<a href="([^"#]+)">([^<]+)</a>\n\s+\\(<a (?:title="MD5 hash"\n\s+)'
    'href="[^?]+\?:action=show_md5&amp;digest=([0-9a-f]{32***REMOVED***)">md5</a>\\)'
)
URL_SCHEME = re.compile('([-+.a-z0-9]{2,***REMOVED***):',re.I).match
        ...
        def scan(link):
            ...
            if link.startswith(self.index_url):
                ...
                if len(parts)==2 and '#' not in parts[1]:
                    ...
                    self.package_pages.setdefault(pkg.lower(),{***REMOVED***)[link] = True
    ...
    if os.path.isfile(filename):
        ...
        for f in os.listdir(filename):
            ...
            if f == 'index.html':
                ...
                f += '/'
            files.append('<a href="{name***REMOVED***">{name***REMOVED***</a>'.format(name=f))
        else:
            tmpl = ("<html><head><title>{url***REMOVED***</title>"
                "</head><body>{files***REMOVED***</body></html>")
